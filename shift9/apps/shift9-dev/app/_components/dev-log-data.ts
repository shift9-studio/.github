...
export const DEV_LOG = [
  {
    ...
    s: "17 SEP 2026",
    sc: "dev" as const,
    d: "By September 17, Short 7 was public on Bring Up Desk. I also worked on a recovery path for an oversized cover image: it can prepare a smaller upload copy without changing the approved source, recognise a video that is already public, and reconnect the dashboard when its status feed drops. The repair is still in testing and review. The goal is less babysitting, with a dashboard that tells me what actually happened.",
  },
  {
    n: "Flow State gets an Ubuntu address",
    s: "17 SEP 2026",
    sc: "rnd" as const,
    d: "I took Flow State another step beyond Windows with an Ubuntu X11 preview that puts spoken words into a real editor. Ten recorded-audio trials delivered the exact text, and the offline installer was checked through install, upgrade and removal without losing the user's dictionary. This covers the Ubuntu X11 setup; broader Linux and Wayland support are still ahead.",
  },
  {
    n: "Apparently apps do not market themselves",
    s: "17 SEP 2026",
    sc: "rnd" as const,
    d: "I started a focused growth push for Feelspoon, with social posts and eight personal introductions to food creators and Android reviewers. The campaign links straight to Google Play while the website catches up. There are no install, subscription or revenue results to claim yet. Apparently pressing publish on an app does not also summon its audience.",
  },
  {
    n: "A graveyard with something to break",
    s: "12 SEP 2026",
    sc: "rnd" as const,
    d: "I worked with a specialist crew in Grok on Vespers' graveyard: separate stones over dirt, layers of moss and wear, and breakable props with fire surviving on the debris. The aim is a place that reacts when you hit it. A haunted wallpaper can only carry a game so far. This is still a work in progress, with some prop details and final visual approval outstanding.",
  },
  {
    n: "Basketball players need the right skeleton",
    s: "10 SEP 2026",
    sc: "rnd" as const,
    d: "HoopClone's players were having a rough time with basic anatomy. The jersey model was attached to an incompatible skeleton, and the players were also facing the wrong way. I repaired both and checked the result in actual five-on-five footage. Feet, stops, defensive slides and ball contact still need work, but getting everyone pointed in the right direction feels like a reasonable first demand of a basketball team.",
  },
  {
    n: "Apparently files aren't small enough yet",
    s: "22 AUG 2026",
    sc: "rnd" as const,
    d: "I've been chasing a better way to squeeze big piles of files down. With s9, I tested removing repeated chunks before compressing what remained. The corrected benchmarks found useful gains on some repetitive data, and a scan of my project files found plenty of exact duplicates. There is a tradeoff between smaller archives and quickly pulling out one file. Still an experiment, still chasing the bigger idea. Physics has declined to make my random bytes smaller.",
  },
  {
