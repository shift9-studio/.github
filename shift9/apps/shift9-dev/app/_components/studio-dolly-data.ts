...
export const SET_PIECES: SetPiece[] = [
  ...
  },
  {
    ...
    status: "IN DEV",
    resolution: "volatile",
    note: "A portable React component workbench with live demos and copyable snippets for teams to bring into their own products. In active development.",
  ...
  },
  {
    ...
    status: "LIVE",
    resolution: "resolved",
    note: "Shift-9's production design system: shared interaction, motion and accessibility rules across live products, with each product free to keep its own voice.",
