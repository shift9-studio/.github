...
| 01 | Just a Pinch | LIVE | clip `set-pieces/01-just-a-pinch.mp4` — 5s, the pinch of seasoning falls in discrete grains, the recipe step advances | `99620b15-7b72-415f-a52b-f296dc73d825` | 8.75 | **Approved** |
...
Total spent on the set-pieces: **12 plates × 4 + 12 clips, eleven at 5s and
Lumen's at 10s = 48 + 8.75 × 11 + 17.5 = 161.75 credits.**

01 was approved as a plate before the all-twelve-animated decision, so its clip
was shot last, after the other eleven.
...
`studio-entry-curtain.png` — the current still shift9.dev opens on. It keeps the
threshold idea while giving the entrance its own neutral, tactile frame: dark
woven material, warm light, and a clear right side for the invitation copy.
