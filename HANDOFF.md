...
| Studio flagship | `shift9/apps/shift9-dev` | shift9.dev | Built: `/`, `/instrument`, `/work/[slug]`. On the entry-experience branch `/` becomes the entrance and `/studio`, `/start`, `/soon` are added — see `PROGRESS.md`. |
